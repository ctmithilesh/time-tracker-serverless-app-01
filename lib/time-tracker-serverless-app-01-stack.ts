...
export class TimeTrackerServerlessApp01Stack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    this.appName = 'TimeTrackerCDKApp'
   ...
   /*
     ...
     */
        private createCustomerTable = () => {
          this.customerTable = new Table(this, `${this.appName}-TimeTracker-Table`, {
     ...
     */
        private createCustomerApiLambda = () => {
          this.customerApiLambda = new Function(this, `${this.appName}-Tasks-Lambda`, {
